                      ...
                      <div>
                        <Row className="g-3">
                          ...
                          <Col lg={12} className="text-end ms-auto">
                            ...
                            <div style={{ listStyle: "none", paddingRight: 15 }}>
                              <h6 style={{ fontSize: "18px" }}>{demandeConge.leaveType.name_ar}</h6>
                              {demandeConge.leaveType?.name_fr !== "congé annuel" && (
                                <span>{demandeConge.subcategory?.name_ar}</span>
                              )}
                              {demandeConge.leaveType?.name_fr === "Congé exceptionnel" && (
      <span style={{ fontSize: "18px" }}> 	...........................................................................                              : موجبها </span>
    )}
                            </div>
                          </Col>
                          ...
                          <Col lg={12} className="text-end ms-auto p-2">
                            <ul style={{ listStyle: "none", paddingRight: 15 }}>
                              <li>
                                <h6 style={{ fontSize: "18px" }} className="mb-3">
                                  <span>
                                    {" "}
...
:
                                  {"   "}
                                  <span>{demandeConge.personnelId?.poste?.poste_ar!}</span>
                                </h6>
                              </li>
                              <li>
                                <h6 style={{ fontSize: "18px" }} className="mb-3">
                              ...
                              <li>
                                ...
                                :
                                {"  "}
                                  <span>{demandeConge.personnelId?.service?.service_ar!}</span>
                                </h6>
                              </li>
                              <li>
                                <div>
                                  <h6 style={{ fontSize: "18px" }} className="mb-3">مركز العمل
                                    : {"  "}
                                  <span>
                                    المعهد العالي للعلوم التطبيقية و التكنلوجيا
                                    بقفصة
                                  </span>
                                  </h6>
                                </div>
  ...
  <h6 style={{ fontSize: "18px" }} className="mb-3">
    ...
    <span>
      {(() => {
        ...
        const startDate = new Date(demandeConge.startDay);
        const endDate = new Date(demandeConge.endDay);

        // Calculate the number of days between start and end date
        const timeDiff = Math.abs(endDate - startDate);
        const daysDiff = Math.ceil(timeDiff / (1000 * 3600 * 24)) + 1; // Adding 1 to include the start day
        ...
        return (
          <>
            {daysDiff} أيام من {formattedStartDate} إلى {formattedEndDate}
          </>
        );
      })()}
    </span>
                         ...
                         <Col lg={4} className="text-end ms-auto">
                            <h6 style={{ fontSize: "18px" }}>قفصة في: 13-11-2024</h6>
                            <h6 style={{ fontSize: "18px" }}>الإمضاء و الختم:</h6>
                            <span>........................</span>
                          </Col>
                          <Col lg={4} className=" ms-auto">
                          <ul style={{ listStyle: "none", paddingRight: 15 }}>
                            <li>
                            <h6 style={{ fontSize: "17px" }}>ملاحظة الرئيس المباشر:</h6>
                            <span>........................</span>
                            </li>
                            <li>
                            <h6 style={{ fontSize: "17px" }}>قفصة في: 13-11-2024</h6>
                            <h6 style={{ fontSize: "17px" }}>إمضاء طالب العطلة:</h6>
                            <span>........................</span>
                            </li>
                          </ul>
