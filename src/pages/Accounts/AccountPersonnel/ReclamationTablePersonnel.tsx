...
const ReclamationTablePersonnel = () => {
    ...
    console.log("reclamation personnel", reclamations)
    const filteredReclamation = reclamations?.filter((reclamation) => (reclamation.personnelId as unknown as { _id: string })._id === idPersonnel);
        ...
        <React.Fragment>
                      ...
                      <Col md={9}>
                          ...
                          <div className="flex-grow-1 card-title m-2">
                            <h5> {personnelDetails.nom_fr} {personnelDetails.prenom_fr}
                            </h5>
                          </div>
...
export default ReclamationTablePersonnel;
