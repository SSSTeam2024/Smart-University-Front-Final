...
const ReclamationEnseignantTable = () => {
    ...
    console.log("id student",idEnseignant)


    const { data: reclamations, error, isLoading } = useFetchReclamationsEnseignantQuery();
    console.log("reclamationenseignant", reclamations)
    const filteredReclamation = reclamations?.filter((reclamation) => (reclamation.enseignantId as unknown as { _id: string })._id === idEnseignant);
        ...
        <React.Fragment>
                      ...
                      <Col md={9}>
                          ...
                          <div className="flex-grow-1 card-title m-2">
                            <h5> {EnseignantDetails.nom_fr} {EnseignantDetails.prenom_fr}
                            </h5>
                          </div>
...
export default ReclamationEnseignantTable;
