        ...
        accessor: (dossierAdministratif: DossierAdministratif) => {
          return (
            <ul className="hstack gap-2 list-unstyled mb-0">
                {actionAuthorization("/gestion-personnel/details-dossier-administratif",user?.permissions!)?
               <li>
                <Link
              ...
              {actionAuthorization("/gestion-personnel/edit-dossier-administratif",user?.permissions!)?
              <li>
                <Link
