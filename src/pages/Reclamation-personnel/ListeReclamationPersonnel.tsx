...
const ListeReclamationPersonnel = () => {
  ...
  const handleNavigate = () => {
    navigate('/reclamation-personnel/ajouter-reclamation-personnel');
  };
  const handleDeleteReclamation = async (id: string) => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                Header: "Personnel",
                accessor: (row: any) => `${row.personnelId?.nom_fr || ""} ${row.personnelId?.prenom_fr || ""}`,
                disableFilters: true,
                filterable: true,
            },
            {
            ...
            },
            {
                 ...
                 },
                 {
                    ...
                    accessor: (row: any) => new Date(row.updatedAt).toLocaleDateString('fr-FR'),
                    disableFilters: true,
                    filterable: true,
                },
            // {
                                ...
                                <Card.Body>
                                    <Row className="g-lg-2 g-4">
                                        ...
                                        <Col sm={3} className="col-lg-auto ms-auto">
                                            <Button   onClick={handleNavigate} variant='primary' type="button" className="w-100 add-btn">
