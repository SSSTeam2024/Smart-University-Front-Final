...
import PDFTable from "./TableExample"; // Create a new PDFTable component
...
Font.register({
  family: "Arial",
  src: "https://fonts.gstatic.com/s/arial/v11/H6FslWI0hy9t7UBqHvU-U9Pf.woff2", // Link to Arial font
  fonts: [
    {
      src: "https://fonts.gstatic.com/s/arial/v11/H6FslWI0hy9t7UBqHvU-U9Pf.woff2",
      fontWeight: "normal",
    },
    {
      src: "https://fonts.gstatic.com/s/arial/v11/H6FslWI0hy9t7UBqHvU-U9Pf-Bold.woff2",
      fontWeight: "bold",
    },
  ],
});
...
const BodyPDF = forwardRef<HTMLDivElement, ChildProps>((props: any, ref) => {
  ...
  const [newUpdateBody, setNewUpdateBody] = useState<string>(
    piece_demande?.body ?? ""
  ...
  //                    <tbody>
  //                      <tr>
  //                        <td style="border: 1px solid black; width: 100%;">inside table</td>
  //                      </tr>
  //                    </tbody>
  //                  </table>`;
