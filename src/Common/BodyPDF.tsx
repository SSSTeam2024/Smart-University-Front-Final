...
const BodyPDF: React.FC<ChildProps> = ({
  ...
  if (newBody?.includes("اسم-الطالب")) {
    newBody = newBody?.replace( "اسم-الطالب", studentId.prenom_ar + " " + studentId.nom_ar);
  }
  ...
  if (newBody?.includes("حالة-حساب-الطالب" )) {
    newBody = newBody?.replace("حالة-حساب-الطالب",studentId.etat_compte.etat_ar );
  }
  if (newBody?.includes("مجموعة-الطالب" )) {
    newBody = newBody?.replace("مجموعة-الطالب",studentId.groupe_classe.nom_classe_ar );
  }
  ...
  if (newBody?.includes("نوع-التسجيل" )) {
    newBody = newBody?.replace("نوع-التسجيل",studentId.type_inscription.type_ar );
  }


   // STUDENT fr
   if (newBody?.includes("nom_etudiant")) {
    newBody = newBody?.replace("nom_etudiant", studentId.prenom_fr + " " + studentId.nom_fr);
  }
...
if (newBody?.includes("عنوان-المؤسسة")) {
  ...
  if (newBody?.includes("Date_d'aujourd'hui")) {
   ...
   if (newBody?.includes("nom_personnel_fr")) {
    newBody = newBody?.replace(/nom_personnel_fr/g, personnelId.nom_fr + " " + personnelId.prenom_fr);
  }
...
if (newBody?.includes("date_affectation_personnel")) {
    newBody = newBody.replace(/date_affectation_personnel/g, personnelId?.date_affectation!);
}
if (newBody?.includes("date_naissance_personnel")) {
    newBody = newBody.replace(/date_naissance_personnel/g, personnelId?.date_naissance!);
}
if (newBody?.includes("etat_civil_personnel")) {
    newBody = newBody.replace(/etat_civil_personnel/g, personnelId?.etat_civil!);
}
if (newBody?.includes("etat_compte_personnel")) {
    newBody = newBody.replace(/etat_compte_personnel/g, personnelId?.etat_compte?.etat_fr!);
}
if (newBody?.includes("service_personnel")) {
    newBody = newBody.replace(/service_personnel/g, personnelId?.service?.service_fr!);
}
if (newBody?.includes("grade_personnel")) {
    newBody = newBody.replace(/grade_personnel/g, personnelId?.grade?.grade_fr!);
}
if (newBody?.includes("compte_courant_personnel")) {
    newBody = newBody.replace(/compte_courant_personnel/g, personnelId?.compte_courant!);
}
if (newBody?.includes("identifiant_unique_personnel")) {
  newBody = newBody.replace(/identifiant_unique_personnel/g, personnelId?.identifinat_unique!);
}
...
if (newBody?.includes("nom_conjoint_personnel")) {
  newBody = newBody.replace(/nom_conjoint_personnel/g, personnelId?.nom_conjoint!);
}
if (newBody?.includes("profession_conjoint_personnel")) {
  newBody = newBody.replace(/profession_conjoint_personnel/g, personnelId?.job_conjoint!);
}
if (newBody?.includes("nombre_fls_personnel")) {
  newBody = newBody.replace(/nombre_fls_personnel/g, personnelId?.job_conjoint!);
}
...
if (newBody?.includes("اسم-الموظف")) {
  newBody = newBody.replace(/اسم-الموظف/g, personnelId.nom_ar + " " + personnelId.prenom_ar);
}

if (newBody?.includes("تاريخ-ولادة-الموظف")) {
  newBody = newBody.replace(/تاريخ-ولادة-الموظف/g, personnelId.date_naissance);
}
...
if (newBody?.includes("مكان-ولادة-الموظف")) {
  newBody = newBody.replace(/مكان-ولادة-الموظف/g, personnelId.lieu_naissance_ar);
}

if (newBody?.includes("تاريخ-الحاق-الموظف")) {
  newBody = newBody.replace(/تاريخ-الحاق-الموظف/g, personnelId.date_affectation);
}
...
if (newBody?.includes("حالة-حساب-الموظف")) {
  newBody = newBody.replace(/حالة-حساب-الموظف/g, personnelId.etat_compte.etat_ar);
}

if (newBody?.includes("الخطة-الوظيفية-للموظف")) {
  newBody = newBody.replace(/الخطة-الوظيفية-للموظف/g, personnelId.poste.poste_ar);
}
...
if (newBody?.includes("صنف-الموظف")) {
  newBody = newBody.replace(/صنف-الموظف/g, personnelId.categorie.categorie_ar);
}
...
if (newBody?.includes("الحساب-الجاري-للموظف")) {
  newBody = newBody.replace(/الحساب-الجاري-للموظف/g, personnelId.compte_courant);
}

if (newBody?.includes("تاريخ-اصدار-بطاقة-الموظف")) {
  newBody = newBody.replace(/تاريخ-اصدار-بطاقة-الموظف/g, personnelId.date_delivrance);
}
...
if (newBody?.includes("وظيفة-زوج-الموظف")) {
 ...
 if (newBody?.includes("nom_enseignant")) {
  newBody = newBody.replace(/nom_enseignant/g, enseignantId.nom_fr + " " + enseignantId.prenom_fr);
}
...
if (newBody?.includes("date_naissance_enseignant")) {
  newBody = newBody.replace(/date_naissance_enseignant/g, enseignantId.date_naissance);
}

if (newBody?.includes("etat_civil_enseignant")) {
  newBody = newBody.replace(/etat_civil_enseignant/g, enseignantId.etat_civil);
}

if (newBody?.includes("etat_compte_enseignant")) {
  newBody = newBody.replace(/etat_compte_enseignant/g, enseignantId.etat_compte.etat_fr);
}
...
if (newBody?.includes("specialité_enseignant")) {
  newBody = newBody.replace(/specialité_enseignant/g, enseignantId.specilaite.specialite_fr);
}

if (newBody?.includes("departement_enseignant")) {
  newBody = newBody.replace(/departement_enseignant/g, enseignantId.departements.name_fr);
}
...
if (newBody?.includes("compte_courant_enseignant")) {
  newBody = newBody.replace(/compte_courant_enseignant/g, enseignantId.compte_courant);
}

if (newBody?.includes("identifiant_unique_enseignant")) {
  newBody = newBody.replace(/identifiant_unique_enseignant/g, enseignantId.identifinat_unique);
}
...
if (newBody?.includes("nom_conjoint_enseignant")) {
  newBody = newBody.replace(/nom_conjoint_enseignant/g, enseignantId.nom_conjoint);
}

if (newBody?.includes("profession_conjoint_enseignant")) {
  newBody = newBody.replace(/profession_conjoint_enseignant/g, enseignantId.job_conjoint);
}

if (newBody?.includes("nombre_fils_enseignant")) {
  newBody = newBody.replace(/nombre_fils_enseignant/g, enseignantId.nombre_fils);
}

// enseignant AR

if (newBody?.includes("مكان-ولادة-الأستاذ")) {
  newBody = newBody.replace(/مكان-ولادة-الأستاذ/g, enseignantId.lieu_naissance_ar);
}

if (newBody?.includes("تاريخ-الحاق-الأستاذ")) {
  newBody = newBody.replace(/تاريخ-الحاق-الأستاذ/g, enseignantId.date_affectation);
}

if (newBody?.includes("الحالة-المدنية-للأستاذ")) {
  newBody = newBody.replace(/الحالة-المدنية-للأستاذ/g, enseignantId.etat_civil);
}
...
if (newBody?.includes("حالة-حساب-الأستاذ")) {
  newBody = newBody.replace(/حالة-حساب-الأستاذ/g, enseignantId.etat_compte.etat_ar);
}

if (newBody?.includes("الخطة-الوظيفية-للأستاذ")) {
  newBody = newBody.replace(/الخطة-الوظيفية-للأستاذ/g, enseignantId.grade.grade_ar);
}
...
if (newBody?.includes("الحساب-الجاري-للأستاذ")) {
  newBody = newBody.replace(/الحساب-الجاري-للأستاذ/g, enseignantId.compte_courant);
}

if (newBody?.includes("تاريخ-اصدار-بطاقة-الأستاذ")) {
  newBody = newBody.replace(/تاريخ-اصدار-بطاقة-الأستاذ/g, enseignantId.date_delivrance);
}
...
if (newBody?.includes("تاريخ-ولادة-الأستاذ")) {
  newBody = newBody.replace(/تاريخ-ولادة-الأستاذ/g, enseignantId.date_naissance);
}
...
if (newBody?.includes("الاختصاص-الأستاذ")) {
  newBody = newBody.replace(/الاختصاص-الأستاذ/g, enseignantId.specilaite.specialite_ar);
}
